import defaultData from "@/content/home/CompanyProfile.json";
...
interface ICompanyProfile {
  items?: ICompanyProfileItem[];
}

const CompanyProfile: React.FC<ICompanyProfile> = ({ items = defaultData }) => {
  return (
    <section id="company-profile" className="py-[80px] px-[10px] font-noto scroll-mt-20">
